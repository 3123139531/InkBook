...
public class TeamController {
    ...
    public void changeUserPositionInTeam(@PathVariable("team_id") int t_id,@RequestParam("username") String username,@RequestParam("new_position") int position){
        Team team = teamService.selectTeamById(t_id);
        User user = userService.findUserByName(username);
        teamService.updateTeamMemberPosition(team,user,position);
    }
}